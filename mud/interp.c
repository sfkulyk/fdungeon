...
struct  cmd_type        cmd_table       [] =
{
 ...
 { "north",  "север",  do_north, POS_STANDING,  0,  LOG_NEVER,  NOLOG|FREEZE },
 { "east",   "восток", do_east,  POS_STANDING,  0,  LOG_NEVER,  NOLOG|FREEZE },
 { "south",  "юг",     do_south, POS_STANDING,  0,  LOG_NEVER,  NOLOG|FREEZE },
 { "west",   "запад",  do_west,  POS_STANDING,  0,  LOG_NEVER,  NOLOG|FREEZE },
 { "up",     "вверх",  do_up,    POS_STANDING,  0,  LOG_NEVER,  NOLOG|FREEZE },
 { "down",   "вниз",   do_down,  POS_STANDING,  0,  LOG_NEVER,  NOLOG|FREEZE },

 // Common other commands
 { "at",          "ат",          do_at,          POS_DEAD,    102,  WIZ_SECURE, NOMOB|HIDE },
 { "auction",     "аукцион",     do_auction,     POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|NOMOB|SPAM|NOARMY|FREEZE|NOLOG },
 { "account",     "счет",        do_account,     POS_SLEEPING,  0,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE|SAVE },
 { "cast",        "колдовать",   do_cast,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOZRIT|NOALL|FREEZE|NOLOG },
 { "chat",        "чат",         do_chat,        POS_DEAD,      0,  WIZ_GSPEAKS,SHOW|MORPH|HIDE|SPAM|NOMOB },
 { "censored",    "цензура",     do_censored,    POS_DEAD,      1,  WIZ_GSPEAKS,SHOW|MORPH|HIDE|SPAM|NOMOB|FREEZE },
 { "buy",         "купить",      do_buy,         POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|FREEZE|NOLOG },
 { "bounty",      "награда",     do_bounty,      POS_DEAD,      0,  WIZ_SKILLS, SHOW|MORPH|NOMOB|SPAM|FREEZE|SAVE },
 { "channels",    "каналы",      do_channels,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "deaf",        "тишина",      do_deaf,        POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "exits",       "выходы",      do_exits,       POS_RESTING,   0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "get",         "взять",       do_get,         POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|NOLOG },
 { "goto",        "гото",        do_goto,        POS_DEAD,    102,  WIZ_SECURE, SHOW|FREEZE },
 { "group",       "группа",      do_group,       POS_SLEEPING,  0,  LOG_NEVER,  SHOW|HIDE|NOLOG },
 { "guild",       "гильдия",     do_guild,       POS_DEAD,      1,  WIZ_SECURE, SHOW|MORPH|NOMOB|NOORDER|FREEZE },
 { "hit",         "напасть",     do_kill,        POS_FIGHTING,  0,  WIZ_SKILLS, NOZRIT|FREEZE|NOLOG },
 { "inventory",   "рюкзак",      do_inventory,   POS_DEAD,      0,  WIZ_SECURE, SHOW|HIDE|NOLOG|NOMOB },
 { "kill",        "убить",       do_kill,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOZRIT|FREEZE|NOLOG },
 { "look",        "смотреть",    do_look,        POS_RESTING,   0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOLOG },
 { "leader",      "лидер",       do_leader,      POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|NOMOB|HIDE|NOORDER|FREEZE },
 { "clan",        "склан",       do_clantalk,    POS_SLEEPING,  0,  WIZ_SPEAKS, SHOW|MORPH|HIDE|SPAM },
 { "clanwork",    "кланворк",    do_clanwork,    POS_DEAD,    107,  WIZ_SECURE, SHOW|MORPH|HIDE|NOMOB|FREEZE|NOPUB },
 { "clanrecall",  "кланрекал",   do_clan_recall, POS_FIGHTING,  0,  WIZ_SECURE, SHOW|NOADR|FREEZE|SAVE|NOLOG },
 { "sprecal",     "спрекал",     do_sprecall,    POS_FIGHTING,  0,  WIZ_SECURE, SHOW|NOADR|FREEZE|SAVE|NOLOG|NOMOB },
 { "petition",    "заявление",   do_petition,    POS_SLEEPING,  0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOORDER|FREEZE|SAVE },
 { "cleader",     "кланлидер",   do_cleader,     POS_DEAD,    107,  WIZ_SECURE, SHOW|OLC|NOMOB|FREEZE },
 { "music",       "петь",        do_music,       POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|MORPH|SPAM|NOMOB },
 { "oauction",    "оаукцион",    do_oauction,    POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|SPAM|NOMOB },
 { "order",       "приказ",      do_order,       POS_RESTING,   0,  WIZ_SKILLS, SHOW|FREEZE|NOLOG },
 { "practice",    "практиковать",do_practice,    POS_SLEEPING,  0,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE|SAVE|NOLOG },
 { "rest",        "отдыхать",    do_rest,        POS_SLEEPING,  0,  LOG_NEVER,  SHOW|FREEZE|NOLOG },
 { "sit",         "сесть",       do_sit,         POS_SLEEPING,  0,  LOG_NEVER,  SHOW|FREEZE|NOLOG },
 { "sockets",     "сокет",       do_sockets,     POS_DEAD,    104,  WIZ_SECURE, SHOW|MORPH|NOLOG|OLC|FREEZE|NOPUB|NOMOB },
 { "rape",        "насиловать",  do_rape,        POS_FIGHTING,  2,  WIZ_SKILLS, SHOW|NOMOB|NOZRIT|SPAM|FREEZE|NOLOG },
 { "mlove",       "секс",        do_rape,        POS_RESTING,   2,  WIZ_SPEAKS, SHOW|NOMOB|NOZRIT|SPAM|FREEZE|NOLOG },
 { "stand",       "встать",      do_stand,       POS_SLEEPING,  0,  LOG_NEVER,  SHOW|FREEZE|NOLOG },
 { "stopfoll",    "остановить",  do_stopfoll,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|NOMOB|HIDE|FREEZE|NOLOG },
 { "tell",        "сказать",     do_tell,        POS_RESTING,   0,  WIZ_SPEAKS, SHOW|MORPH|HIDE|SPAM },
 { "unlock",      "отпереть",    do_unlock,      POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "wield",       "вооружиться", do_wear,        POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|SAVE|NOLOG },
 { "wizhelp",     "иммсправка",  do_wizhelp,     POS_DEAD,    102,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "spec",        "спец",        do_spec,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOMOB|FREEZE|NOLOG },
 { "spam",        "спам",        do_spam,        POS_DEAD,      0,  WIZ_CONFIG, SHOW|NOMOB|HIDE|MORPH|NOORDER|NOLOG },
 { "affects",     "аффекты",     do_affects,     POS_DEAD,      0,  LOG_NEVER,  SHOW|NOMOB|MORPH|HIDE|NOLOG },
 { "areas",       "арии",        do_areas,       POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "changes",     "изменения",   do_changes,     POS_DEAD,      0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "commands",    "команды",     do_commands,    POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "compare",     "сравнить",    do_compare,     POS_RESTING,   0,  LOG_NEVER,  SHOW|NOMOB|FREEZE|NOLOG },
 { "complain",    "жалоба",      do_complain,    POS_SLEEPING,  0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "consider",    "определить",  do_consider,    POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|FREEZE|NOLOG },
 { "count",       "сколько",     do_count,       POS_SLEEPING,  0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "credits",     "автора",      do_credits,     POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG },
 { "equipment",   "снаряжение",  do_equipment,   POS_DEAD,      0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOLOG },
 { "examine",     "изучить",     do_examine,     POS_RESTING,   0,  LOG_NEVER,  SHOW|NOMOB|NOLOG },
 { "help",        "справка",     do_help,        POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG },
 { "idea",        "идея",        do_idea,        POS_DEAD,      0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "bugreport",   "багрепорт",   do_bugreport,   POS_DEAD,      0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "inform",      "информация",  do_inform,      POS_SLEEPING,  0,  LOG_NEVER,  SHOW|HIDE|NOLOG|NOMOB },
 { "motd",        "мотд",        do_motd,        POS_DEAD,      0,  LOG_NEVER,  MORPH|NOMOB|NOLOG },
 { "news",        "новости",     do_news,        POS_DEAD,      0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "bulletin",    "бюллетень",   do_news,        POS_DEAD,      0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "report",      "рапорт",      do_report,      POS_RESTING,   0,  WIZ_SECURE, SHOW|NOLOG|FREEZE },
 { "magazine",    "газета",      do_newspaper,   POS_DEAD,      0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "run",         "бежать",      do_run,         POS_STANDING,  0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOORDER|FREEZE|NOLOG },
 { "rules",       "правила",     do_rules,       POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG },
 { "scan",        "осмотреться", do_scan,        POS_RESTING,   0,  WIZ_SECURE, SHOW|HIDE|NOLOG },
 { "oscore",      "остатистика", do_oscore,      POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "online",      "онлайн",      do_online,      POS_DEAD,      0,  WIZ_SECURE, SHOW|NOMOB|MORPH|HIDE|NOLOG },
 { "score",       "статистика",  do_score,       POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "skills",      "навыки",      do_skills,      POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "socials",     "социалы",     do_socials,     POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOZRIT|SPAM|FREEZE|NOLOG },
 { "gsocials",    "глобально",   do_gsocial,     POS_DEAD,      3,  WIZ_GSPEAKS,SHOW|MORPH|SPAM|FREEZE|NOMOB|NOLOG },
 { "sedit",       "седит",       do_sedit,       POS_DEAD,    103,  WIZ_SECURE, SHOW|OLC|NOMOB },
 { "spells",      "заклинания",  do_spells,      POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|NOLOG|NOMOB },
 { "time",        "время",       do_time,        POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "tournament",  "tournament",  do_tournament,  POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|NOORDER|NOMOB|FREEZE|NOPUB },
 { "weather",     "погода",      do_weather,     POS_RESTING,   0,  LOG_NEVER,  SHOW|HIDE|NOLOG|NOMOB },
 { "who",         "кто",         do_who,         POS_DEAD,      0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "whois",       "показать",    do_whois,       POS_DEAD,      0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "wizlist",     "боги",        do_wizlist,     POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOLOG|NOMOB },
 { "worth",       "отчет",       do_worth,       POS_SLEEPING,  0,  WIZ_SECURE, SHOW|HIDE|NOLOG|NOMOB },
 { "charge",      "charge",      do_charge,      POS_STANDING,  0,  WIZ_SKILLS, SHOW|NOMOB|NOORDER|NOLOG|FREEZE },

 // Configuration commands
 { "alias",       "алиас",         do_alias,       POS_DEAD,      0,  WIZ_CONFIG, MORPH|HIDE|FULL|NOMOB|NOORDER|FREEZE|SAVE|NOFORCE },
 { "autolist",    "автосписок",    do_autolist,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "autoassist",  "автопомощь",    do_autoassist,  POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|FREEZE|SAVE|NOLOG },
 { "autogold",    "автозолото",    do_autogold,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "autoloot",    "автоснаряжение",do_autoloot,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "autosac",     "автожертвы",    do_autosac,     POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "brief",       "кратко",        do_brief,       POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "colour",      "цвета",         do_colour,      POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "description", "описание",      do_description, POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "remove",      "снять",         do_remove,      POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "delete",      "удалить",       do_delete,      POS_STANDING,  0,  WIZ_SECURE, SHOW|FULL|NOMOB|NOORDER|FREEZE|NOFORCE },
 { "remort",      "переродится",   do_remort,      POS_STANDING,101,  WIZ_SECURE, SHOW|FULL|NOMOB|NOORDER|FREEZE },
 { "nofollow",    "непускать",     do_nofollow,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|NOLOG },
 { "nosummon",    "непризывать",   do_nosummon,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOORDER|NOLOG },
 { "nodelete",    "ноделете",      do_nodelete,    POS_DEAD,    109,  WIZ_PENALT, SHOW|MORPH|HIDE|NOMOB|FULL },
 { "nocancel",    "ноканцел",      do_nocancel,    POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOORDER|NOLOG },
 { "nosend",      "непринимать",   do_nosend,      POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOORDER|FREEZE|NOLOG },
 { "outfit",      "оутфит",        do_outfit,      POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|FREEZE|SAVE },
 { "offline",     "оффлайн",       do_offline,     POS_DEAD,      0,  WIZ_SECURE, SHOW|HIDE|NOMOB|OLC|NOPUB },
 { "offer",       "заказ",         do_offer,       POS_DEAD,      1,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOORDER|FREEZE },
 { "password",    "пароль",        do_password,    POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|NOORDER|SAVE|NOLOG|NOFORCE },
 { "prompt",      "строка",        do_prompt,      POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "scroll",      "скроллинг",     do_scroll,      POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "title",       "титл",          do_title,       POS_DEAD,      1,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "unalias",     "уналиас",       do_unalias,     POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|FULL|NOORDER|FREEZE|SAVE },
 { "wimpy",       "трусость",      do_wimpy,       POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|FREEZE|NOLOG },

 /*** Communication commands. ***/
 { "afk",         "афк",       do_afk,         POS_SLEEPING,  0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|FREEZE|SAVE|NOLOG },
 { "answer",      "ответ",     do_answer,      POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|SPAM|NOMOB },
 { "emote",       "эмоция",    do_emote,       POS_RESTING,   0,  WIZ_SPEAKS, SHOW|SPAM|NOZRIT },
 { "pmote",       "пмоте",     do_pmote,       POS_RESTING,   0,  WIZ_SPEAKS, SHOW|SPAM|NOZRIT },
 { ".",           "кричать",   do_gossip,      POS_SLEEPING,  0,  WIZ_GSPEAKS,SPAM|NOARMY },
 { "gossip",      "кричать",   do_gossip,      POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|SPAM|NOARMY },
 { ",",           "эмоция",    do_emote,       POS_RESTING,   0,  WIZ_SPEAKS, SPAM|NOZRIT },
 { "newbiechat",  "ньюьбие",   do_newbiechat,  POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|HIDE|SPAM|NOMOB },
 { "grats",       "поздравить",do_grats,       POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|HIDE|SPAM|NOMOB },
 { "gtell",       "сказгруппе",do_gtell,       POS_DEAD,      0,  WIZ_SPEAKS, SHOW|HIDE|SPAM },
 { ";",           ";",         do_gtell,       POS_DEAD,      0,  WIZ_SPEAKS, HIDE|SPAM },
 { "note",        "сообщение", do_note,        POS_SLEEPING,  0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOORDER|NOLOG },
 { "offtopic",    "сообщение", do_offtopic,    POS_SLEEPING,  0,  WIZ_NOTES,  SHOW|MORPH|HIDE|NOMOB|NOORDER|NOLOG },
 { "quest",       "задание",   do_quest,       POS_SLEEPING,  0,  WIZ_SECURE, SHOW|NOMOB|HIDE|FREEZE|SAVE|NOLOG },
 { "question",    "вопрос",    do_question,    POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|SPAM },
 { "quenia",      "изречь",    do_quenia,      POS_RESTING,   0,  WIZ_SPEAKS, SHOW|FREEZE|NOMOB },
 { "quote",       "цитировать",do_quote,       POS_SLEEPING,  0,  WIZ_GSPEAKS,SHOW|SPAM|NOMOB },
 { "reply",       "ответить",  do_reply,       POS_SLEEPING,  0,  WIZ_SPEAKS, SHOW|HIDE|SPAM },
 { "replay",      "повторить", do_replay,      POS_SLEEPING,  0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB },
 { "say",         "произнести",do_say,         POS_RESTING,   0,  WIZ_SPEAKS, SHOW|SPAM },
 { "'",           "'",         do_say,         POS_RESTING,   0,  WIZ_SPEAKS, SPAM },
 { "shout",       "крикнуть",  do_shout,       POS_RESTING,   3,  WIZ_GSPEAKS,SHOW|SPAM },
 { "alli",        "союзники",  do_alli,        POS_SLEEPING,  0,  WIZ_SPEAKS, SHOW|SPAM|HIDE|NOMOB|MORPH },
 { "yell",        "орать",     do_yell,        POS_RESTING,   0,  WIZ_SPEAKS, SHOW|SPAM },

 { "showprac",    "показпрак", do_showprac,    POS_SLEEPING,  0,  LOG_NEVER,  SHOW|HIDE|NOMOB|NOLOG },
 { "showskill",   "показнавык",do_showskill,   POS_DEAD,      0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "unread",      "нечитанных",do_unread,      POS_SLEEPING,  0,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|NOLOG },

 /*** Object manipulation commands. ***/
 { "brandish",    "взмахнуть", do_brandish,    POS_RESTING,   0,  WIZ_SKILLS, SHOW|NOZRIT|NOALL|FREEZE|SAVE|NOLOG },
 { "close",       "закрыть",   do_close,       POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "drink",       "выпить",    do_drink,       POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|SAVE|NOLOG },
 { "drop",        "бросить",   do_drop,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|NOLOG },
 { "eat",         "съесть",    do_eat,         POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "envenom",     "отравить",  do_envenom,     POS_RESTING,   0,  WIZ_SKILLS, SHOW|FREEZE|NOLOG },
 { "fill",        "наполнить", do_fill,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|SAVE|NOLOG },
 { "give",        "дать",      do_give,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|NOLOG },
 { "send",        "послать",   do_send,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|NOZRIT|FREEZE |NOLOG},
 { "heal",        "лечить",    do_heal,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|SAVE|NOLOG },
 { "hold",        "одеть",     do_wear,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|SAVE|NOLOG },
 { "list",        "список",    do_list,        POS_RESTING,   0,  WIZ_SECURE, SHOW|HIDE|FREEZE|NOLOG },
 { "lock",        "запереть",  do_lock,        POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "open",        "открыть",   do_open,        POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "pick",        "взломать",  do_pick,        POS_RESTING,   0,  WIZ_SKILLS, SHOW|NOZRIT|FREEZE|NOLOG },
 { "pour",        "опорожнить",do_pour,        POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|SAVE|NOLOG },
 { "push",        "пнуть",     do_push,        POS_STANDING,  0,  WIZ_SKILLS, SHOW|NOZRIT|FREEZE|NOLOG },
 { "put",         "положить",  do_put,         POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|NOLOG },
 { "quaff",       "глотнуть",  do_quaff,       POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|SAVE|NOLOG },
 { "recite",      "прочесть",  do_recite,      POS_RESTING,   0,  WIZ_SKILLS, SHOW|NOZRIT|NOALL|FREEZE|NOLOG },
 { "sell",        "продать",   do_sell,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|FREEZE|NOLOG },
 { "take",        "взять",     do_get,         POS_RESTING,   0,  WIZ_SECURE, SHOW|NOZRIT|FREEZE|NOLOG },
 { "talks",       "разговоры", do_talk,        POS_DEAD,      0,  WIZ_CONFIG, SHOW|NOMOB|NOORDER|MORPH|HIDE|FREEZE|SAVE },
 { "pose",        "поза",      do_pose,        POS_RESTING,   0,  WIZ_CONFIG, SHOW|NOMOB|NOORDER|MORPH|HIDE|NOLOG },
 { "sacrifice",   "уничтожить",do_sacrifice,   POS_RESTING,   0,  WIZ_SACCING,SHOW|NOZRIT|FREEZE|NOLOG },
 { "junk",        "жертвоприношение", do_sacrifice,POS_RESTING,0, WIZ_SACCING,NOZRIT|FREEZE|NOLOG },
 { "tap",         "уничтожить",do_sacrifice,   POS_RESTING,   0,  WIZ_SACCING,NOZRIT|FREEZE|NOLOG },
 { "value",       "оценить",   do_value,       POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|FREEZE|NOLOG },
 { "wear",        "надеть",    do_wear,        POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "zap",         "махнуть",   do_zap,         POS_RESTING,   0,  WIZ_SKILLS, SHOW|NOZRIT|NOALL|FREEZE|NOLOG },
 { "exchange",    "обменять",  do_exchange,    POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|FREEZE|NOLOG },
 { "clanfit",     "кланобнов", do_clanfit,     POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|FREEZE|SAVE },
 { "clanbank",    "кланбанк",  do_clanbank,    POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|NOORDER|OLC|NOARMY|FREEZE|SAVE },
 { "repair",      "чинить",    do_repair,      POS_STANDING,  0,  WIZ_SKILLS, SHOW|NOMOB|NOORDER|FREEZE|SAVE },
 { "reward",      "наградить", do_reward,      POS_DEAD,    106,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE|SAVE },
 { "damage",      "повредить", do_damage,      POS_DEAD,    107,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE|SAVE },
 { "confiscate",  "забрать",   do_seize,       POS_DEAD,    105,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE|SAVE },
 ...
 { "forge",       "ковать",    do_forge,       POS_STANDING,109,  WIZ_SKILLS, SHOW|NOMOB|NOORDER|FREEZE|SAVE },
 { "ldefend",     "узащита",   do_ldefend,     POS_STANDING,110,  WIZ_SKILLS, SHOW|NOMOB|NOORDER|FREEZE|SAVE },

 // Combat commands
 { "backstab",    "бэкстаб",    do_backstab,    POS_STANDING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },
 { "bash",        "сбить",      do_bash,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },
 { "throw",       "метнуть",    do_throw,       POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOZRIT|NOMOB|FREEZE|NOLOG },
 { "bs",          "бс",         do_backstab,    POS_FIGHTING,  0,  WIZ_SKILLS, NOALL|FREEZE|NOLOG },
 { "berserk",     "ярость",     do_berserk,     POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|FREEZE|NOLOG },
 { "cleave",      "разбить",    do_cleave,      POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },
 { "dirt",        "ослепить",   do_dirt,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|FREEZE|NOLOG },
 { "disarm",      "обезоружить",do_disarm,      POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|SAVE|NOLOG },
 { "flee",        "сбежать",    do_flee,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|FREEZE|NOLOG },
 { "kick",        "пнуть",      do_kick,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },
 { "murder",      "убить",      do_murder,      POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|FULL|HIDE|FREEZE|NOLOG },
 { "rescue",      "спасти",     do_rescue,      POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOZRIT|FREEZE|NOLOG },
 { "trip",        "подножка",   do_trip,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },
 { "pray",        "молиться",   do_pray,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOORDER|FREEZE|NOLOG },
 { "shock",       "врезать",    do_shock_hit,   POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },
 { "strangle",    "придушить",  do_strangle,    POS_STANDING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },
 { "frame",       "подставить", do_frame,       POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOALL|FREEZE|NOLOG },

 // Miscellaneous commands
 { "polyanarecall","polyanare",  do_polyanarecall,POS_SLEEPING,  0,  LOG_NEVER,  SHOW|HIDE|NOMOB|NOFORCE },
 { "config",      "конфигурация", do_config,      POS_DEAD,      0,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOORDER|SAVE|NOLOG },
 { "seen",        "сиин",         do_seen,        POS_DEAD,      0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOPUB },
 { "backup",      "архив",        do_backup,      POS_DEAD,      0,  WIZ_SECURE, SHOW|FULL|NOMOB|NOORDER|OLC|FREEZE|NOPUB },
 { "backup2",     "архив2",       do_backup2,     POS_DEAD,    102,  WIZ_SECURE, SHOW|FULL|NOMOB|NOORDER|OLC|FREEZE|NOPUB },
 { "blink",       "мерцать",      do_blink,       POS_DEAD,      0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOMOB|SAVE|NOLOG|FREEZE },
 { "enter",       "войти",        do_enter,       POS_STANDING,  0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "follow",      "следовать",    do_follow,      POS_STANDING,  0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "gain",        "учить",        do_gain,        POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE|SAVE },
 { "go",          "зайти",        do_enter,       POS_STANDING,  0,  WIZ_SECURE, NOORDER|FREEZE|NOLOG },
 { "hide",        "спрятаться",   do_hide,        POS_RESTING,   0,  WIZ_SKILLS, SHOW|FREEZE|NOLOG },
 { "play",        "проиграть",    do_play,        POS_RESTING,   2,  WIZ_SECURE, SHOW|FREEZE|NOMOB },
 { "mob",         "моб",          do_mob,         POS_DEAD,      0,  LOG_NEVER,  NOORDER|FREEZE|NOFORCE },
 { "quit",        "выйти",        do_quit,        POS_DEAD,      0,  WIZ_LOGINS, SHOW|FULL|NOMOB|NOORDER|FREEZE },
 { "quiet",       "глухота",      do_quiet,       POS_DEAD,      0,  WIZ_CONFIG, SHOW|FULL|NOMOB|NOORDER|FREEZE|NOLOG },
 { "recall",      "рекал",        do_recall,      POS_FIGHTING,  0,  WIZ_SECURE, SHOW|FREEZE|SAVE|NOLOG },
 { "/",           "/",            do_recall,      POS_FIGHTING,  0,  WIZ_SECURE, FREEZE|NOLOG },
 { "save",        "сохранить",    do_save,        POS_DEAD,      0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOORDER|FREEZE },
 { "sleep",       "спать",        do_sleep,       POS_SLEEPING,  0,  WIZ_SECURE, SHOW|FREEZE|SAVE|NOLOG },
 { "sneak",       "красться",     do_sneak,       POS_STANDING,  0,  WIZ_SKILLS, SHOW|HIDE|FREEZE|NOLOG },
 { "split",       "поделить",     do_split,       POS_RESTING,   0,  WIZ_SECURE, SHOW|FREEZE|NOLOG },
 { "steal",       "украсть",      do_steal,       POS_STANDING,  0,  WIZ_SKILLS, SHOW|HIDE|FREEZE },
 { "train",       "тренировать",  do_train,       POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE|NOLOG },
 { "visible",     "видимый",      do_visible,     POS_SLEEPING,  0,  LOG_NEVER,  SHOW|FREEZE|NOLOG },
 { "wake",        "проснуться",   do_wake,        POS_SLEEPING,  0,  LOG_NEVER,  SHOW|FREEZE|NOLOG },
 { "where",       "где",          do_where,       POS_RESTING,   0,  WIZ_SECURE, SHOW|HIDE|NOLOG|NOMOB },
 { "crimereport", "криминал",     do_crimereport, POS_RESTING,   0,  WIZ_SECURE, SHOW|NOMOB|NOORDER|FREEZE },
 { "ahelp",       "асправка",     do_ahelp,       POS_DEAD,      0,  WIZ_SECURE, SHOW|MORPH|NOMOB|HIDE|NOLOG },
 
 // Deity commands
 { "devote",      "посвятить", do_devote,      POS_DEAD,     21,  WIZ_SECURE,  MORPH|HIDE|NOMOB|NOORDER|NOFORCE },
// { "supplicate",  "молить",    do_supplicate,  POS_STUNNED,   0,  WIZ_SECURE,  MORPH|HIDE|NOMOB|NOORDER|NOFORCE },
 { "deity",       "божить",    do_deity,       POS_DEAD,    109,  WIZ_SECURE,  MORPH|HIDE|NOMOB|NOORDER|NOFORCE },
 ...
 { "ban",         "бан",       do_ban,         POS_DEAD,    105,  WIZ_SECURE, SHOW|MORPH|OLC|NOPUB|NOFORCE },
 { "pban",        "пбан",      do_pban,        POS_DEAD,    101,  WIZ_SECURE, SHOW|MORPH|OLC|NOPUB|NOMOB|NOFORCE },
 ...
 { "setcurse",    "проклять",  do_setcurse,    POS_DEAD,    107,  WIZ_PENALT, SHOW|NOMOB|OLC|FREEZE|NOPUB|NOORDER },

 // Race Skills
 { "tail",        "хвост",     do_tail,        POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOORDER|FREEZE|NOLOG },
 { "crush",       "толкнуть",  do_crush,       POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOORDER|FREEZE|NOLOG },
 { "blacksmith",  "перековать",do_blacksmith,  POS_STANDING,  0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOORDER|FREEZE },
 { "vbite",       "укус",      do_vbite,       POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOORDER|NOMOB|FREEZE|NOLOG },
 { "resurrect",   "возродить", do_resurrect,   POS_FIGHTING,  0,  WIZ_SKILLS, SHOW|NOMOB|FREEZE|NOLOG },

 { "travel",      "путешествовать",   do_travel,      POS_STANDING,  0,  WIZ_SECURE, NOMOB|FREEZE },
 ...
 { "pcheck",      "проверить",   do_check,       POS_DEAD,    109,  WIZ_SECURE, NOMOB|OLC|NOPUB|NOORDER|FULL|NOLOG },
 ...
 { "arenarecall", "арена",       do_arecall,     POS_FIGHTING,  0,  WIZ_SECURE, SHOW|NOADR|NOORDER|SAVE|NOMOB|NOLOG|FREEZE },
 ...
 { "lore",        "узнать",      do_lore,        POS_RESTING,   0,  WIZ_SKILLS, SHOW|FREEZE|NOMOB|NOLOG|FREEZE },
 { "morph",       "превратиться",do_polymorph,   POS_RESTING,   0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOORDER|FREEZE },
 { "reform",      "перекинуться",do_reform,      POS_RESTING,   0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOMOB|NOORDER|FREEZE|SAVE },
 { "referi",      "рефери",      do_referi,      POS_STANDING,  0,  WIZ_SECURE, SHOW|HIDE|NOMOB|NOORDER|FREEZE|NOLOG },
 { "test",        "unknown",     do_test,        POS_RESTING,   1,  LOG_NEVER,  SHOW|MORPH|HIDE|NOMOB|FREEZE|NOPUB },
 { "version",     "версия",      do_version,     POS_DEAD,      0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOMOB },
 { "vote",        "голосовать",  do_vote,        POS_DEAD,      0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOMOB|NOLOG },
 { "global",      "глобал",      do_global,      POS_DEAD,    103,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|OLC },
 { "suicide",     "умереть",     do_suicide,     POS_DEAD,      0,  WIZ_SECURE, SHOW|MORPH|HIDE|NOMOB|FULL|NOADR|NOORDER|FREEZE|SAVE },
 { "diplomacy",   "дипломатия",  do_diplomacy,   POS_DEAD,      1,  WIZ_CONFIG, SHOW|MORPH|HIDE|NOMOB|NOORDER|FREEZE },
 ...
 { "kazad",       "казад",       do_kazad,       POS_DEAD,      0,  WIZ_SPEAKS, SHOW|NOORDER|MORPH|HIDE|NOMOB },
 { "avenge",      "ассасин",     do_avenge,      POS_DEAD,      0,  WIZ_SPEAKS, SHOW|NOORDER|MORPH|HIDE|NOMOB },
 { "gaccount",    "гсчет",       do_gaccount,    POS_DEAD,      0,  WIZ_SKILLS, SHOW|NOORDER|MORPH|HIDE|NOMOB|FREEZE|SAVE },
 ...
 { "marry",       "предложение", do_marry,       POS_STANDING,  1,  WIZ_SKILLS, SHOW|NOMOB|NOORDER|NOADR|FREEZE|OLC},
 { "ptalk",       "ссказать",    do_ptalk,       POS_DEAD,      1,  WIZ_SPEAKS, SHOW|NOMOB|HIDE|MORPH },
 { "divorce",     "развод",      do_divorce,     POS_STANDING,  1,  WIZ_SKILLS, SHOW|NOMOB|HIDE|NOORDER|FREEZE|OLC},
 { "race",        "раса",        do_race,        POS_DEAD,    106,  WIZ_SECURE, SHOW|NOMOB|HIDE|OLC|NOORDER},
 { "fly",         "взлететь",    do_fly,         POS_FIGHTING,  1,  WIZ_SKILLS, SHOW|FREEZE|NOLOG},
 { "walk",        "приземлится", do_walk,        POS_FIGHTING,  1,  WIZ_SKILLS, SHOW|FREEZE|NOLOG},
 { "smoke",       "курить",      do_smoke,       POS_RESTING,   1,  WIZ_SPEAKS, HIDE|NOMOB|NOORDER|NOPUB|FREEZE },
 { "russian",     "русский",     do_russian,     POS_DEAD,      1,  WIZ_SECURE, SHOW|MORPH|NOORDER|NOMOB|FREEZE },
 { "mist",        "туман",       do_mist,        POS_STANDING,  1,  WIZ_SKILLS, SHOW|FREEZE|NOLOG },
 { "howl",        "вой",         do_howl,        POS_STANDING,  1,  WIZ_SKILLS, SHOW|MORPH|NOMOB|FREEZE|NOLOG },
 { "gquest",      "гквест",      do_gquest,      POS_DEAD,      1,  WIZ_SKILLS, HIDE|MORPH|NOMOB|FREEZE|NOARMY|NOORDER },
 { "lash",        "лаш",         do_lash,        POS_FIGHTING,  1,  WIZ_SKILLS, MORPH|NOMOB|FREEZE|NOLOG },
 { "dig",         "закопаться",  do_dig,         POS_DEAD,      1,  WIZ_SKILLS, MORPH|NOMOB|FREEZE },
 { "pacify",      "от..здить",   do_pacify,      POS_STANDING,  1,  WIZ_SKILLS, SHOW|NOMOB|FREEZE|NOARMY|NOALL },
