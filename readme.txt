...
=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
MUD based on Diku Mud (see creds.txt for all contributors and codebases)
...
MUD code is pretty easy to understand even for newbie.
