...
// Saboteur: unfortunately doesn't work correctly.
// Much more changes required to support all control characters which can contain chr(00)
static unsigned char utfEncodeArr[] =
{
  0xd0,0x82,0xd0,0x83,0xe2,0x80,0xd1,0x93,0xe2,0x80,0xe2,0x80,0xe2,0x80,0xe2,0x80, // 0x80-0x87
  0xe2,0x82,0xe2,0x80,0xd0,0x89,0xe2,0x80,0xd0,0x8a,0xd0,0x8c,0xd0,0x8b,0xd0,0x8f, // 0x88-0x8f
  0xd1,0x92,0xe2,0x80,0xe2,0x80,0xe2,0x80,0xe2,0x80,0xe2,0x80,0xe2,0x80,0xe2,0x80, // 0x90-0x97
  0x00,0x20,0xe2,0x84,0xd1,0x99,0xe2,0x80,0xd1,0x9a,0xd1,0x9c,0xd1,0x9b,0xd1,0x9f, // 0x98-0x9f
  0xc2,0xa0,0xd0,0x8e,0xd1,0x9e,0xd0,0x88,0xc2,0xa4,0xd2,0x90,0xc2,0xa6,0xc2,0xa7, // 0xa0-0xa7
  0xd0,0x81,0xc2,0xa9,0xd0,0x84,0xc2,0xab,0xc2,0xac,0xc2,0xad,0xc2,0xae,0xd0,0x87, // 0xa8-0xaf ¨
  0xc2,0xb0,0xc2,0xb1,0xd0,0x86,0xd1,0x96,0xd2,0x91,0xc2,0xb5,0xc2,0xb6,0xc2,0xb7, // 0xb0-0xb7
  0xd1,0x91,0xe2,0x84,0xd1,0x94,0xc2,0xbb,0xd1,0x98,0xd0,0x85,0xd1,0x95,0xd1,0x97, // 0xb8-0xbf ¸
  0xd0,0x90,0xd0,0x91,0xd0,0x92,0xd0,0x93,0xd0,0x94,0xd0,0x95,0xd0,0x96,0xd0,0x97, // 0xc0-0xc7 ÀÁÂÃÄÅÆÇ
  0xd0,0x98,0xd0,0x99,0xd0,0x9a,0xd0,0x9b,0xd0,0x9c,0xd0,0x9d,0xd0,0x9e,0xd0,0x9f, // 0xc8-0xcf ÈÉÊËÌÍÎÏ
  0xd0,0xa0,0xd0,0xa1,0xd0,0xa2,0xd0,0xa3,0xd0,0xa4,0xd0,0xa5,0xd0,0xa6,0xd0,0xa7, // 0xd0-0xd7 ÐÑÒÓÔÕÖ×
  0xd0,0xa8,0xd0,0xa9,0xd0,0xaa,0xd0,0xab,0xd0,0xac,0xd0,0xad,0xd0,0xae,0xd0,0xaf, // 0xd8-0xdf ØÙÚÛÜÝÞß
  0xd0,0xb0,0xd0,0xb1,0xd0,0xb2,0xd0,0xb3,0xd0,0xb4,0xd0,0xb5,0xd0,0xb6,0xd0,0xb7, // 0xe0-0xe7 àáâãäåæç
  0xd0,0xb8,0xd0,0xb9,0xd0,0xba,0xd0,0xbb,0xd0,0xbc,0xd0,0xbd,0xd0,0xbe,0xd0,0xbf, // 0xe8-0xef èéêëìíîï
  0xd1,0x80,0xd1,0x81,0xd1,0x82,0xd1,0x83,0xd1,0x84,0xd1,0x85,0xd1,0x86,0xd1,0x87, // 0xf0-0xf7 ðñòóôõö÷
  0xd1,0x88,0xd1,0x89,0xd1,0x8a,0xd1,0x8b,0xd1,0x8c,0xd1,0x8d,0xd1,0x8e,0xd1,0x8f  // 0xf8-0xff øùúûüýþÿ
};
//  KOI8-R
...
static unsigned char koi8rDecodeArr[] =
{
...
long EncodeUTF (char * pWindows, char * pUTF)
{
  const char * pUTFstart = pUTF;
  char * pEnd;
  unsigned char ch;
  long nLen = strlen (pWindows);
  ...
  for (pEnd = pWindows + nLen; pWindows < pEnd; pWindows++)
  {
    ...
    if (ch >= 128)
    {
      *pUTF++ = utfEncodeArr[ (ch - 128) * 2];
      *pUTF++ = utfEncodeArr[ (ch - 128) * 2 + 1];
    }
    else
    {
      *pUTF++ = ch;
